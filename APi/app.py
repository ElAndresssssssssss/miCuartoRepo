...
def get_cursos_platzi():
    rows = ["Curso de Python", "Curso de JavaScript", "Curso de Data Science", "Curso de Marketing Digital", "Curso de Diseño UX/UI", "Curso de Desarrollo Web", "Curso de Machine Learning"]
    return rows